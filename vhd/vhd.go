...
const (
	...
	createVirtualDiskFlagSupportSparseFileAnyFs            CreateVirtualDiskFlag = 0x400
...
func CreateVhdx(path string, maxSizeInGb, blockSizeInMb uint32) error {
	...
	handle, err := CreateVirtualDisk(path, VirtualDiskAccessNone, CreateVirtualDiskFlagSparseFile|createVirtualDiskFlagSupportSparseFileAnyFs, &params)
	if err != nil {
		return err
	}
